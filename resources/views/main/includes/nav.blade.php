<nav class="w-full h-[150px]">
    ...
    <div class="w-full h-[100px] flex items-center justify-between px-16">
        <a href="/" class="h-full text-3xl font-extrabold"><img src="{{ asset('img/VetFinder-logo-text.png') }}"
                alt="Logo VetFinder" class="h-full"></a>
        <div class="flex items-center">
            {{-- TODO: Search from - kiedy zrobione będą wyniki i page --}}
            <form class="flex items-center" action="" method="post">
                @csrf
                <input type="text" name=""
                    class="w-[500px] h-[50px] border-none bg-gray-500 text-white placeholder-white"
