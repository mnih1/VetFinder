    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between flex-col gap-4">
        ...
        <div>
            <span class="inline-flex shadow-sm rounded-md">
                ...
                @else
                    <a href="{{ $paginator->previousPageUrl() }}" class="inline-flex items-center px-2 py-2 text-sm font-medium bg-bg text-white border border-white rounded-l-md" aria-label="Previous Page">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                        </svg>
                    </a>
                ...
                {{-- Next Page Link --}}
                @if ($paginator->hasMorePages())
                    <a href="{{ $paginator->nextPageUrl() }}" class="inline-flex items-center px-2 py-2 -ml-px text-sm font-medium bg-bg text-white border border-white rounded-r-md" aria-label="Next Page">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
